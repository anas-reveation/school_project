  ...
  <div>
    ...
    <div class="row sev-2 mt-5 pt-4">
      <div class="col-md-12 col-lg-5">
        <h4 class="service-t fw-semibold">Benifits of Orthodontic Treatment</h4>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
    ...
    <div class="sev-2 mt-5 pt-3">
      <div class="text-center mb-4">
        ...
        <h4 class="service-t fw-semibold">
          Get the best results in the Orthodontic Treatment
        </h4>
      </div>
      <div class="row">
        <div class="col-md-6">
          <img src="../assets/img/ortho3.png" class="w-100" />
          <p class="text-center fw-semibold mt-2">Before</p>
        </div>
        <div class="col-md-6">
          <img src="../assets/img/ortho4.png" class="w-100" />
