    ...
    <div class="sev-2 mt-5 pt-3">
      ...
      >
        <h2 class="fw-bold secondary mb-3 col-xl-8 col-md-12 text-center">
          ...
          <span class="primary">Orthodontic Treatment</span>
        </h2>
      </div>
      <div class="row">
        <div class="col-md-6">
          <img
            src="../assets/img/ortho-d-svg.webp"
        ...
        <div class="col-md-6">
          <img
            src="../assets/img/ortho4-svg.webp"
      ...
      <p>
        Vardan Dental is the location for you if you want a stunning new smile.
        See ours before and after pictures of orthodontic treatment.
      </p>
    </div>
  </div>
</template>
