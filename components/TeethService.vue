<template>
  <div class="row">
    <div class="col-md-12 col-lg-12">
      <h4 class="service-t fw-semibold">How They Work</h4>
      <!-- <p>
      ...
      <ul class="row">
        ...
        <li class="col-md-12">Although the best whitening results are most often achieved when performed by a dentist, there are a wide range of do-it-yourself teeth whitening options available (dentist prescribed and over the counter). Basic over-the-counter whitening options have the lowest concentration of peroxide, limiting their whitening strength.</li>
        <li class="col-md-12">The treatment procedure varies depending on the specific whitening option you select. In-office whitening generally takes one hour or less, during which a bleaching gel is applied to the surface of the teeth for one or more periods of 15 to 30 minutes. A high-intensity light may be used to help speed up the process. Patients will see whitened results immediately after treatment.</li>
        <li class="col-md-12">Although results are immediate, teeth whitening is not a permanent solution to discoloration. Dentists often prescribe take-home trays designed to maximize the effect and prolong results. In addition, certain foods and drinks should be avoided.</li>
        <li class="col-md-12">
        ...
        <li class="col-md-12">The veneer procedure varies from case to case, but is typically completed over a six week period and two dental visits — each of which can last several hours. The initial visit involves a diagnostic evaluation to ensure that there are no oral health concerns that may affect treatment, in addition to selecting veneer color from a shade chart. Some dentists use outside labs for veneer fabrication, while others use in-office CAD/CAM technology to fabricate onsite in a single visit. Depending on your dentist, temporary veneers may be used between visits.</li>
        <li class="col-md-12">During the actual procedure appointment, a local anesthetic is administered to minimize discomfort. After placement your dentist will speak with you about how best to maximize the longevity of your veneers. This includes avoiding overly abrasive toothpastes and biting down on hard objects. If treated properly, veneers can last 15 years or longer before needing replaced.</li>
      </ul>
      <h4 class="service-t fw-semibold">Are you a Candidate?</h4>
      <ul class="row">
        <li class="col-md-12">
